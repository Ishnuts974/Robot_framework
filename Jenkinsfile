    ...
    stages {
        ...
        stage('Upload Results to Xray') {
            steps {
                ...
                curl -H "Content-Type: text/xml" -X POST -H "Authorization: Bearer %TOKEN%" -F "file=@results\\output.xml" %XRAY_URL%/api/v1/import/execution/robot?projectKey=POEI2&testPlanKey=POEI2-1072
                """
                }
            }
